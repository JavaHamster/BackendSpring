...
public class Utils {
	...
	public static int COLOR = at.ac.htlinn.hamsterProgram.hamsterEvaluation.debugger.model.Hamster.BLUE;
			...
			if (file != null && file.exists() && file.isFile()
				...
				if (str != null)
					if (str.toUpperCase().equals("BLAU")
						...
						Utils.COLOR = at.ac.htlinn.hamsterProgram.hamsterEvaluation.debugger.model.Hamster.BLUE;
					} else if (str.toUpperCase().equals("ROT")
							|| str.toUpperCase().equals("RED")) {
						Utils.COLOR = at.ac.htlinn.hamsterProgram.hamsterEvaluation.debugger.model.Hamster.RED;
					} else if (str.toUpperCase().equals("GRUEN")
							|| str.toUpperCase().equals("GREEN")) {
						Utils.COLOR = at.ac.htlinn.hamsterProgram.hamsterEvaluation.debugger.model.Hamster.GREEN;
					} else if (str.toUpperCase().equals("GELB")
							|| str.toUpperCase().equals("YELLOW")) {
						Utils.COLOR = at.ac.htlinn.hamsterProgram.hamsterEvaluation.debugger.model.Hamster.YELLOW;
					} else if (str.toUpperCase().equals("CYAN")) {
						Utils.COLOR = at.ac.htlinn.hamsterProgram.hamsterEvaluation.debugger.model.Hamster.CYAN;
					} else if (str.toUpperCase().equals("MAGENTA")) {
						Utils.COLOR = at.ac.htlinn.hamsterProgram.hamsterEvaluation.debugger.model.Hamster.MAGENTA;
					} else if (str.toUpperCase().equals("ORANGE")) {
						Utils.COLOR = at.ac.htlinn.hamsterProgram.hamsterEvaluation.debugger.model.Hamster.ORANGE;
					} else if (str.toUpperCase().equals("PINK")) {
						Utils.COLOR = at.ac.htlinn.hamsterProgram.hamsterEvaluation.debugger.model.Hamster.PINK;
					} else if (str.toUpperCase().equals("GRAU")
							|| str.toUpperCase().equals("GRAY")) {
						Utils.COLOR = at.ac.htlinn.hamsterProgram.hamsterEvaluation.debugger.model.Hamster.GRAY;
					} else if (str.toUpperCase().equals("WEISS")
							|| str.toUpperCase().equals("WHITE")) {
						Utils.COLOR = at.ac.htlinn.hamsterProgram.hamsterEvaluation.debugger.model.Hamster.WHITE;
					}
				at.ac.htlinn.hamsterProgram.hamsterEvaluation.debugger.model.Hamster.$i$defColor = Utils.COLOR;
			}
		} catch (Exception exc) {
		}
